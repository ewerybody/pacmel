"""
pacmel package creation script to prepare deploying itself with itself.
I love self referencing stuff!
"""
import os
import pacmel
...
def pac_yourself():
    """
    Pack the necessary files of itself into a `pacmel.mel`.
    """
